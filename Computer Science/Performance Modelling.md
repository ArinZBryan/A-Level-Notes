Performance modelling is the process of simulating different user and system configurations and loads by using mathematical approximation, rather than real-world testing (which would be more desirable to do). This is generally done as real-word testing can be costly, both in terms of time and money. 
