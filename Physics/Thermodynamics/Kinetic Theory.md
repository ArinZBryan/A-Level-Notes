...
6. Now we need to consider the whole box. In the whole box, there are N molecules and, on average, a third of them are striking each pair of faces. The average (RMS) speed of the molecules is ${c^2}_{RMS}$ or $<c^2>$ , so:
7. Total Pressure $p = \frac{\frac{1}{3}NM<c^2>}{V}$