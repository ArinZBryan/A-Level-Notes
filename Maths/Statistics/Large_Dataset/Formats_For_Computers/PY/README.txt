...
- Place the python file in the source directory of your project
...
dataset = large_dataset.Large_Dataset("./../CSV") #This is the relative path as the files are downloaded
